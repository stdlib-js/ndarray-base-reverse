...
* // returns [ [ 6, 5 ], [ 4, 3 ], [ 2, 1 ] ]
*/
declare function reverse<T = unknown>( x: genericndarray<T>, writable: boolean ): genericndarray<T>;
...
* // returns [ [ 6, 5 ], [ 4, 3 ], [ 2, 1 ] ]
*/
declare function reverse<T = unknown>( x: typedndarray<T>, writable: boolean ): typedndarray<T>;
